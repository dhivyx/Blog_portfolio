...
function Blogs() {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);//if page gets reloaded the it comes back to top of the page
    ...
    return (
        <div className="blog-section py-14">
            ...
            {/* Blog creation form */}
            {/* Checkin whether the admin is or not, if not blog cannot be created */}
            {admin ?
            ...
            <div className="blogs-container grid grid-cols-1 md:grid-cols-2 gap-6 mt-5 container mx-auto px-4">
                {blogs.map((blog) => (
                    // Here blog._id is in this form because, data 'll be stored in {"_id":, "title":, "likes":}
